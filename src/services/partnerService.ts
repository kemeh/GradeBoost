...
export const DEFAULT_PARTNERS: Partner[] = [
  ...
  },
  {
    ...
    shortDescEn: 'Powering Edulpha\'s Gemini 1.5 Flash AI grading engine and scalable cloud infrastructure.',
    shortDescFr: 'Alimente le moteur de correction IA Gemini 1.5 Flash et l\'infrastructure cloud d\'Edulpha.',
    fullDescEn: 'Leveraging cutting-edge Gemini models for instant step-by-step problem solving in Mathematics, Physics, Chemistry, and French Essay evaluation.',
    fullDescFr: 'Utilisation des modèles Gemini de pointe pour la résolution instantanée de problèmes pas à pas.',
    categoryId: 'cat-tech',
