...
const ANALYTICS_EVENTS_KEY = 'gb60_analytics_events';
const GENERATED_REPORTS_KEY = 'gb60_generated_reports';
...
export class AnalyticsService {
  ...
  static downloadReportFile(report: GeneratedReport): void {
    ...
    if (report.format === 'csv' || report.format === 'excel') {
      ...
      content = `GradeBoost60 Analytics Report: ${report.title}\n`;
      ...
      fileExtension = 'txt';
      content = `====================================================\n`;
      content += `          GRADEBOOST60 EXECUTIVE REPORT             \n`;
      content += `====================================================\n\n`;
