      ...
      <nav
        className={cn(
          ...
          isScrolled
            ...
            : "bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-slate-200/60 dark:border-slate-800 py-3.5"
        )}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between gap-4">
          
          {/* Left Section: Logo & Platform Title */}
          <div 
          ...
          >
            <img 
              ...
              alt={appName || "Edulpha"} 
              className="h-9 sm:h-10 w-auto rounded-xl object-contain shadow-xs group-hover:scale-105 transition-transform"
              onError={(e) => {
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[8px] sm:text-[9px] font-black tracking-widest text-indigo-600 dark:text-indigo-400 uppercase -mt-1">
          ...
          <div className="hidden lg:flex items-center gap-1 text-xs font-bold text-slate-700 dark:text-slate-300 relative" ref={megaMenuRef}>
              ...
              return (
                <div key={item.id} className="relative">
                  <button
                    ...
                    className={cn(
                      "px-3 py-2 rounded-xl transition-all flex items-center gap-1.5 font-bold hover:bg-slate-100/80 dark:hover:bg-slate-800 hover:text-indigo-600 dark:hover:text-indigo-400",
                  ...
                  >
                    ...
                    {item.badgeEn && (
                      <span className={cn("px-1.5 py-0.5 text-[9px] font-black uppercase rounded-md border", item.badgeColor || 'bg-indigo-50 text-indigo-700 border-indigo-200')}>
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            >
              ...
              <kbd className="hidden lg:inline-block px-1.5 py-0.5 text-[9px] font-black bg-white dark:bg-slate-900 text-slate-500 border border-slate-200 dark:border-slate-700 rounded-md">
                ⌘K
              </kbd>
            </button>
            ...
            {user ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <Link to="/auth">
                  <Button size="sm" className="bg-indigo-600 hover:bg-indigo-700 text-white shadow-md font-black text-xs px-3.5 py-2 rounded-xl">
                    Get Started Free
                  </Button>
                </Link>
              </div>
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-slate-200 transition-colors ml-1"
            >
              <Menu size={20} />
            </button>
          </div>
