...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <div className="hidden md:block bg-slate-900 text-slate-200 px-4 py-1.5 text-xs border-b border-slate-800">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="px-2 py-0.5 rounded-md bg-emerald-600 text-white font-black text-[10px] tracking-wider uppercase shadow-2xs">
              CAMEROON & AFRICA #1
            </span>
          ...
          <button 
            ...
            className="text-indigo-400 hover:text-indigo-300 font-bold flex items-center gap-1 transition-colors group"
          >
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <img 
                ...
                alt={appName || "Edulpha"} 
                className="h-8 sm:h-10 w-auto rounded-xl object-contain shadow-xs group-hover:scale-105 transition-transform"
                onError={(e) => {
              ...
              <div className="flex flex-col">
                ...
                <span className="hidden sm:inline-block text-[8px] sm:text-[9px] font-black tracking-widest text-indigo-600 dark:text-indigo-400 uppercase -mt-1">
