...
export const TRANSLATIONS: TranslationDictionary = {
  ...
  'common.searchPlaceholder': { en: 'Type to search...', fr: 'Tapez pour rechercher...' },
  'common.optional': { en: 'Optional', fr: 'Optionnel' },
  'common.level': { en: 'Level', fr: 'Niveau' },
  'common.academicYear': { en: 'Academic Year', fr: 'Année Académique' },
  'auth.region': { en: 'Region', fr: 'Région' },
  'curriculum.dept': { en: 'Department / Stream', fr: 'Département / Filière' },
  'curriculum.science': { en: 'Science', fr: 'Sciences' },
  'curriculum.arts': { en: 'Arts', fr: 'Lettres / Arts' },
  'curriculum.commercial': { en: 'Commercial', fr: 'Commerce' },
  'curriculum.technical': { en: 'Technical', fr: 'Technique' },
  'curriculum.general': { en: 'General Education', fr: 'Enseignement Général' },
  'curriculum.enrolledHndCourses': { en: 'Enrolled HND Course Modules', fr: 'Modules de cours HND inscrits' },
  'common.studentId': { en: 'Student ID / Matriculation Number', fr: 'Matricule / Identifiant Étudiant' },
  'common.courses': { en: 'courses', fr: 'cours' },
  ...
  // --- Login Page Specific ---
  'auth.login.title': { en: 'Login to Edulpha', fr: 'Connexion à Edulpha' },
  'auth.login.subtitle': { en: 'Primary phone authentication for Cameroon & African learners.', fr: 'Authentification principale par téléphone pour les apprenants du Cameroun et d\'Afrique.' },
  'auth.login.phoneTab': { en: 'Phone Number', fr: 'Numéro de téléphone' },
  'auth.login.emailTab': { en: 'Email Login', fr: 'Connexion par e-mail' },
  'auth.login.loginMode': { en: 'Login Mode', fr: 'Mode de connexion' },
  'auth.login.phonePassword': { en: 'Phone + Password', fr: 'Téléphone + mot de passe' },
  'auth.login.passwordlessOtp': { en: 'Passwordless OTP', fr: 'OTP sans mot de passe' },
  'auth.login.mobilePhone': { en: 'Mobile Phone Number', fr: 'Numéro de téléphone mobile' },
  'auth.login.password': { en: 'Password', fr: 'Mot de passe' },
  'auth.login.rememberMe': { en: 'Remember Me', fr: 'Se souvenir de moi' },
  'auth.login.signInBtn': { en: 'Sign In to Edulpha 🚀', fr: 'Se connecter à Edulpha 🚀' },
  'auth.login.forgotPassword': { en: 'Forgot Password?', fr: 'Mot de passe oublié ?' },
  'auth.login.needAccount': { en: 'Need an account?', fr: 'Vous n\'avez pas de compte ?' },
  'auth.login.registerLink': { en: 'Register', fr: 'S\'inscrire' },
  'auth.login.resetTitle': { en: 'Reset Your Password', fr: 'Réinitialiser votre mot de passe' },
  'auth.login.resetSubtitle': { en: 'Choose phone SMS OTP recovery or email link.', fr: 'Choisissez la récupération par SMS OTP ou par lien e-mail.' },
  'auth.login.smsOtpCode': { en: 'SMS OTP Code', fr: 'Code SMS OTP' },
  'auth.login.emailLink': { en: 'Email Link', fr: 'Lien e-mail' },
  'auth.login.backToLogin': { en: 'Back to Login', fr: 'Retour à la connexion' },
  'auth.login.sendSmsOtp': { en: 'Send SMS Recovery OTP 📲', fr: 'Envoyer l\'OTP de récupération par SMS 📲' },
  'auth.login.sendEmailLink': { en: 'Send Email Reset Link 📧', fr: 'Envoyer le lien de réinitialisation par e-mail 📧' },
  'auth.login.sendPasswordlessOtp': { en: 'Send Passwordless OTP 📲', fr: 'Envoyer l\'OTP sans mot de passe 📲' },
  'auth.login.phonePlaceholder': { en: '+237 670 00 00 00', fr: '+237 670 00 00 00' },
  'auth.login.emailPlaceholder': { en: 'name@example.com', fr: 'nom@exemple.com' },
  'auth.login.passwordPlaceholder': { en: '••••••••', fr: '••••••••' },
  'auth.login.showPassword': { en: 'Show password', fr: 'Afficher le mot de passe' },
  'auth.login.hidePassword': { en: 'Hide password', fr: 'Masquer le mot de passe' },
  'auth.login.error.emptyPhone': { en: 'Please enter your phone number', fr: 'Veuillez entrer votre numéro de téléphone' },
  'auth.login.error.emptyEmail': { en: 'Please enter your email address', fr: 'Veuillez entrer votre adresse e-mail' },
  'auth.login.error.invalidPhone': { en: 'Please enter a valid phone number', fr: 'Veuillez entrer un numéro de téléphone valide' },
  'auth.login.error.accountLocked': { en: 'Account locked due to 5 failed attempts. Please try again in {minutes} minutes.', fr: 'Compte verrouillé en raison de 5 tentatives échouées. Veuillez réessayer dans {minutes} minutes.' },
  'auth.login.error.tooManyAttempts': { en: 'Account locked due to 5 consecutive failed attempts. Please try again in 15 minutes.', fr: 'Compte verrouillé en raison de 5 tentatives consécutives échouées. Veuillez réessayer dans 15 minutes.' },
  'auth.login.error.noAccount': { en: 'No account found with this phone number. Please register first.', fr: 'Aucun compte trouvé avec ce numéro de téléphone. Veuillez d\'abord vous inscrire.' },
  'auth.login.error.general': { en: 'An unexpected error occurred. Please try again.', fr: 'Une erreur inattendue s\'est produite. Veuillez réessayer.' },
  'auth.login.success.resetSent': { en: 'Password reset link sent to your email.', fr: 'Lien de réinitialisation envoyé à votre e-mail.' },
  'auth.login.success.otpSent': { en: 'OTP sent successfully!', fr: 'OTP envoyé avec succès !' },
  'auth.login.loading.sending': { en: 'Sending...', fr: 'Envoi en cours...' },
  'auth.login.loading.verifying': { en: 'Verifying...', fr: 'Vérification...' },
  'auth.login.loading.loggingIn': { en: 'Logging in...', fr: 'Connexion en cours...' },
  'auth.login.createAccountTitle': { en: 'Create Edulpha Account', fr: 'Créer un compte Edulpha' },
  'auth.login.createAccountSubtitle': { en: 'Join Edulpha: GCE, BEPC & Baccalauréat Practical Learning Ecosystem', fr: 'Rejoignez Edulpha : Écosystème d\'apprentissage pratique pour GCE, BEPC et Baccalauréat' },

  // --- Registration Modal ---
  'auth.register.step': { en: 'Step {current} of {total}', fr: 'Étape {current} sur {total}' },
  'auth.register.complete': { en: '{percent}% Complete', fr: '{percent}% Complété' },
  'auth.register.accountType': { en: 'Select Account Type', fr: 'Type de Compte' },
  'auth.register.student': { en: 'Student Learner', fr: 'Étudiant / Élève' },
  'auth.register.studentDesc': { en: 'GCE, BEPC, Baccalauréat', fr: 'GCE, BEPC, Baccalauréat' },
  'auth.register.teacher': { en: 'Teacher / Educator', fr: 'Enseignant / Formateur' },
  'auth.register.teacherDesc': { en: 'LMS & Class Management', fr: 'Gestion de classe & LMS' },
  'auth.register.basicInfo': { en: '1. Basic Personal Information', fr: '1. Informations Personnelles de Base' },
  'auth.register.firstName': { en: 'First Name', fr: 'Prénom' },
  'auth.register.lastName': { en: 'Last Name', fr: 'Nom' },
  'auth.register.confirmPassword': { en: 'Confirm Password', fr: 'Confirmer le mot de passe' },
  'auth.register.country': { en: 'Country', fr: 'Pays' },
  'auth.register.region': { en: 'Region', fr: 'Région' },
  'auth.register.city': { en: 'City', fr: 'Ville' },
  'auth.register.next': { en: 'Next Step', fr: 'Étape Suivante' },
  'auth.register.prev': { en: 'Previous', fr: 'Précédent' },
  'auth.register.finish': { en: 'Complete Registration 🚀', fr: 'Terminer l\'inscription 🚀' },
  'auth.register.error.fields': { en: 'Please fill in all required fields.', fr: 'Veuillez remplir tous les champs obligatoires.' },
  'auth.register.error.passwords': { en: 'Passwords do not match.', fr: 'Les mots de passe ne correspondent pas.' },
  'auth.register.success': { en: 'Account created successfully!', fr: 'Compte créé avec succès !' },

  // --- Curriculum Steps ---
  'auth.register.eduInfo': { en: '2. Education Curriculum & Level', fr: '2. Système Éducatif & Niveau' },
  'auth.register.selCategory': { en: 'Select Academic Level / Category', fr: 'Sélectionner le Niveau Académique / Catégorie' },
  'auth.register.regionCity': { en: 'Region & City', fr: 'Région & Ville' },
  'auth.register.searchInstitution': { en: 'Search Higher Institution', fr: 'Rechercher une Institution Supérieure' },
  'auth.register.nominateInstitution': { en: 'Nominate Institution', fr: 'Proposer une Institution' },
  'auth.register.specialty': { en: 'Accredited Programme / Specialization', fr: 'Filière / Spécialité Accréditée' },
  'auth.register.school': { en: 'School / Institution', fr: 'Établissement / École' },
  'auth.register.dept': { en: 'Department', fr: 'Département' },
  'auth.register.subjectTitle': { en: '3. Select Your Subjects', fr: '3. Sélectionnez vos Matières' },
  'auth.register.goalTitle': { en: '4. Your Learning Goals', fr: '4. Vos Objectifs d\'Apprentissage' },
  'auth.register.prefTitle': { en: '5. Learning Preferences', fr: '5. Préférences d\'Apprentissage' },
  'auth.register.verifyTitle': { en: '6. Verification & Confirmation', fr: '6. Vérification & Confirmation' },
  'auth.register.termsNotice': { 
    en: "By clicking \"Complete Registration\", you agree to Edulpha's terms of service and privacy policy. Your AI Tutor will be instantly personalized to your GCE / Baccalauréat profile.",
    fr: "En cliquant sur \"Terminer l'inscription\", vous acceptez les conditions d'utilisation et la politique de confidentialité d'Edulpha. Votre tuteur IA sera instantanément personnalisé selon votre profil GCE / Baccalauréat."
  },

  // --- OTP Modal ---
  'otp.title': { en: 'Phone Verification', fr: 'Vérification du téléphone' },
  'otp.whatsappPrimary': { en: 'WhatsApp OTP (Primary)', fr: 'OTP WhatsApp (Principal)' },
  'otp.smsFallback': { en: 'SMS OTP (Fallback)', fr: 'OTP SMS (Secours)' },
  'otp.sentWhatsapp': { en: 'We sent a 6-digit WhatsApp verification code to', fr: 'Nous avons envoyé un code de vérification à 6 chiffres via WhatsApp au' },
  'otp.sentSms': { en: 'We sent a 6-digit SMS verification code to', fr: 'Nous avons envoyé un code de vérification à 6 chiffres par SMS au' },
  'otp.enterCode': { en: 'Enter 6-Digit Code', fr: 'Entrez le code à 6 chiffres' },
  'otp.sandboxTitle': { en: 'Sandbox / Test Mode OTP', fr: 'Mode Simulation Sandbox OTP' },
  'otp.sandboxCode': { en: 'Your test verification code is:', fr: 'Votre code de test est :' },
  'otp.autofill': { en: 'Auto-fill', fr: 'Remplir' },
  'otp.verifying': { en: 'Verifying...', fr: 'Vérification...' },
  'otp.verifyBtn': { en: 'Verify & Continue', fr: 'Vérifier le code' },
  'otp.noCode': { en: "Didn't receive your verification code?", fr: 'Vous n\'avez pas reçu le code ?' },
  'otp.resendWhatsapp': { en: 'Resend via WhatsApp', fr: 'Renvoyer sur WhatsApp' },
  'otp.fallbackSms': { en: 'Fallback to SMS', fr: 'Renvoyer par SMS' },
  'otp.whatsappIndisponible': { en: 'WhatsApp verification unavailable. Sent via SMS fallback.', fr: 'WhatsApp indisponible. Un SMS de secours vous a été envoyé.' },
  'otp.codeFilled': { en: 'Test Code Filled!', fr: 'Code rempli !' },
  'otp.enterFullCode': { en: 'Please enter the complete 6-digit code', fr: 'Veuillez entrer le code à 6 chiffres' },
  ...
  'curriculum.hnd': { en: 'Higher National Diploma (HND)', fr: 'Higher National Diploma (HND / BTS)', es: 'Diploma Nacional Superior (HND)', ar: 'الدبلوم الوطني العالي (HND)', de: 'Höheres Nationales Diplom (HND)', pt: 'Diploma Nacional Superior (HND)' },
  'curriculum.hndLevel1': { en: 'HND Level 1 (Year 1)', fr: 'HND Niveau 1 (1ère Année)', es: 'HND Nivel 1 (Año 1)', ar: 'المستوى الأول HND', de: 'HND Stufe 1', pt: 'HND Nível 1 (Ano 1)' },
  'curriculum.hndLevel2': { en: 'HND Level 2 (Year 2 / Exam)', fr: 'HND Niveau 2 (2ème Année / Examen National)', es: 'HND Nivel 2 (Año 2)', ar: 'المستوى الثاني HND', de: 'HND Stufe 2', pt: 'HND Nível 2 (Ano 2)' },
  'curriculum.hndSemester1': { en: 'Semester 1', fr: 'Semestre 1', es: 'Semestre 1', ar: 'الفصل الدراسي 1', de: 'Semester 1', pt: 'Semestre 1' },
  'curriculum.hndSemester2': { en: 'Semester 2', fr: 'Semestre 2', es: 'Semestre 2', ar: 'الفصل الدراسي 2', de: 'Semester 2', pt: 'Semestre 2' },
  'curriculum.hndProgramme': { en: 'HND Programme / Specialty', fr: 'Filière / Spécialité HND', es: 'Programa / Especialidad HND', ar: 'تخصص HND', de: 'HND Programm', pt: 'Programa / Especialidade HND' },
  'curriculum.hndSchool': { en: 'School / Faculty', fr: 'École / Faculté', es: 'Escuela / Facultad', ar: 'الكلية / المدرسة', de: 'Fakultät / Fachbereich', pt: 'Escola / Faculdade' },
  'curriculum.hndDepartment': { en: 'Academic Department', fr: 'Département Académique', es: 'Departamento Académico', ar: 'القسم الأكاديمي', de: 'Akademische Abteilung', pt: 'Departamento Acadêmico' },
  'curriculum.hndCourses': { en: 'HND Courses & Modules', fr: 'Cours et Modules HND', es: 'Cursos y Módulos HND', ar: 'مقررات ووحدات HND', de: 'HND Kurse & Module', pt: 'Cursos e Módulos HND' },
  'curriculum.hndProjects': { en: 'Capstone Projects & Research', fr: 'Projets de Fin d\'Études & Recherche', es: 'Proyectos de Fin de Carrera e Investigación', ar: 'مشاريع التخرج والبحوث', de: 'Abschlussprojekte & Forschung', pt: 'Projetos de Conclusão e Pesquisa' },
