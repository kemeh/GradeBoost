...
export const TRANSLATIONS: TranslationDictionary = {
  ...
  'hero.eyebrow': { en: "🇨🇲 CAMEROON'S SMARTER WAY TO LEARN", fr: "🇨🇲 LA FAÇON LA PLUS INTELLIGENTE D'APPRENDRE AU CAMEROUN" },
  'hero.mainHeadline': { en: 'Master Your Education. Build Your Future. 🚀', fr: 'Maîtrisez votre formation. Construisez votre avenir. 🚀' },
  'hero.supportingHeadline': { en: 'From GCE to HND/BTS, TVEE and beyond — Edulpha puts Cameroon’s complete learning experience in your hands.', fr: 'Du GCE au HND/BTS, TVEE et au-delà — Edulpha met toute l\'expérience d\'apprentissage du Cameroun entre vos mains.' },
  'hero.description': { en: 'Master General Education, Technical Specialties, Commercial Studies, TVEE Intermediate & Advanced levels, HND and BTS with official past papers, comprehensive courses, step-by-step Edulpha AI solutions, practical learning, and offline mobile access.', fr: 'Maîtrisez l\'Enseignement Général, les Spécialités Techniques, les Études Commerciales, les niveaux TVEE Intermédiaire & Avancé, le HND et le BTS avec des épreuves officielles, des cours complets, des solutions IA Edulpha pas à pas, un apprentissage pratique et un accès mobile hors-ligne.' },
  'hero.chips.pastPapers': { en: '📚 Official Past Papers', fr: '📚 Épreuves Officielles' },
  'hero.chips.aiSolutions': { en: '🤖 Edulpha AI Solutions', fr: '🤖 Solutions IA Edulpha' },
  'hero.chips.hndBts': { en: '🎓 HND & BTS Courses', fr: '🎓 Cours HND & BTS' },
  'hero.chips.technical': { en: '🔧 Technical Training', fr: '🔧 Formation Technique' },
  'hero.chips.commercial': { en: '💼 Commercial Studies', fr: '💼 Études Commerciales' },
  'hero.chips.offline': { en: '📱 Offline Learning', fr: '📱 Apprentissage Hors-Ligne' },
  'hero.chips.bilingual': { en: '🇬🇧🇫🇷 English & French', fr: '🇬🇧🇫🇷 Anglais & Français' },
  'hero.btn.startFree': { en: '🚀 Start Learning Free', fr: '🚀 Commencer Gratuitement' },
  'hero.btn.exploreCourses': { en: '📚 Explore Courses', fr: '📚 Explorer les Cours' },
  'hero.trust.row': { en: 'Past Papers • AI Solutions • Practical Learning • Offline Access', fr: 'Épreuves Officielles • Solutions IA • Apprentissage Pratique • Accès Hors-Ligne' },
